...
import { TranslationHistoryItem } from "../pages/ViewerPage";

interface TranslationHistoryProps {
    history: TranslationHistoryItem[];
    onClear: () => void;
    onManualTranslate: (text: string, sourceLang: string, targetLang: string) => void;
    isTranslatingManual: boolean;
}

export default function TranslationHistory({ history, onClear, onManualTranslate, isTranslatingManual }: TranslationHistoryProps) {
